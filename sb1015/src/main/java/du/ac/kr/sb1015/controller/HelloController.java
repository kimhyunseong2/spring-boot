package du.ac.kr.sb1015.controller;

import du.ac.kr.sb1015.dto.DataObject;
...
//    @PostMapping("/")
    public String helloPost(String text1, Model model) {
        model.addAttribute("value", text1);
        model.addAttribute("msg","당신의 이름은 "+text1+"이군요!");
        return "index";
    }
...
//    @GetMapping("/")
    ...
    public ModelAndView index(ModelAndView mav) {
        ...
        data.add(new String[]{"choi", "choi@happy", "777-777-777"});
